...
class Subscribe extends React.Component {
  ...
  render() {
    ...
    let topic = subscribeText || get(categoryObj, 'subscribeText', 'Web development');

    /* eslint-disable no-inline-comments */
    return (<div className = "subscribe-block">
      <p >
            Thanks for taking the time to read this post!
            {' ' + topic} is one of the main topics of this blog,
            so if you enjoyed the post, please consider subscribing by using the feed,
        ...
        <div id = "mc_embed_signup">
          ...
          >
            ...
            <div id = "mc_embed_signup_scroll">
              ...
              <div className = "mc-field-group" style = {{paddingRight: '30px'}}>
                <input
                  type = "email"
                  value = ""
                  name = "EMAIL"
